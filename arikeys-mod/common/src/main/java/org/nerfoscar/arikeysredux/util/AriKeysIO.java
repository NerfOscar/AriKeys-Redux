...
public class AriKeysIO {
	...
	private static final File KEYBIND_FILE = new File(MinecraftClient.getInstance().runDirectory, "arikeysredux.txt");
	...
	public static void load() {
		try {
			...
			LOGGER.error("Failed to load arikeysredux bindings", exception);
		}
	}
	...
	public static void save() {
		try {
			...
			LOGGER.error("Failed to save arikeysredux bindings", exception);
		}
	}
}
