...
import org.nerfoscar.arikeysredux.cmd.AriKeysCommand;
...
public final class AriKeysReduxMain extends JavaPlugin {
    private static AriKeysReduxMain plugin;
    ...
    public static AriKeysReduxMain get() {
        return plugin;
    }
